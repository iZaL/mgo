...
@section('content')
    <h1>Edit Product {{ $post->name }}</h1>

    {{ Form::model($post,array('method' => 'PATCH', 'action' => array('AdminProductsController@update',$post->id), 'role'=>'form', 'files' => true)) }}
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label" for="title">Product Name in Arabic</label>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label" for="title">Product Name in English</label>
