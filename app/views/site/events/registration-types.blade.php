                ...
                <div class="panel-body">
                    ...
                    @if(!$freeEvent)
                        ...
                        <div class="col-md-12">
                            ...
                            <h3 class="text-center"> {{ $event->isFreeEvent() ? trans('word.free_event') : trans('word.price') . ' ' . $setting->convertVipPrice }} </h3></p>
                        </div>
                    @endif
                ...
                <div class="panel-body">
                    ...
                    @if(!$freeEvent)
                        ...
                        <div class="col-md-12">
                            ...
                            <h3 class="text-center">{{ $event->isFreeEvent() ? trans('word.free_event') : trans('word.price') . ' ' . $setting->convertOnlinePrice }} </h3></p>
                        </div>
                    @endif
                ...
                <div class="panel-body">
                    ...
                    @if(!$freeEvent)
                        ...
                        <div class="col-md-12">
                            ...
                            <h3 class="text-center">{{ $event->isFreeEvent() ? trans('word.free_event') : trans('word.price') . ' ' . $event->convertPrice }} </h3></p>
                        </div>
